...
- Cold: 2.5 points per degree for the first 5 degrees below the crag's ideal minimum, then 6 points per degree, capped at 80.
- Heat: 4 points per degree above ideal, capped at 40.
...
Hourly cells display air temperature, while scoring uses apparent temperature.
