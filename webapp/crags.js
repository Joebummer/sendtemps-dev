...
export const AREAS = {
  ...
  'Beechworth / Mt Pilot': ['beechworth-main'],
  'Wilsons Promontory': ['wilsons-prom-main'],
  'Mt Kooyoora': ['mt-kooyoora'],
  'Hillwood': ['hillwood-main'],
  'Cataract Gorge': ['cataract-gorge-main'],
  'Fingal Valley': ['fingal-valley-main'],
  'Cloudy Bay': ['cloudy-bay-main'],
  'Warrumbungles': ['warrumbungles-main'],
  'Wolgan Valley / Newnes': ['wolgan-valley-main'],
  'Gara Gorge': ['gara-gorge-main'],
  'Minto Heights': ['westside-main'],
};
